...
class DAQ_Move_DCServoCube_Abstract(DAQ_Move_base):
    """ Abstract class for Thorlabs DCServo cube instrument plugin.
    ...
    # To redefine in the child class.
    controller_type = None

    # Child class-specific parameters go here.
    # Example:
    #
    #is_multiaxes = False
    #_axes_names = ['']
